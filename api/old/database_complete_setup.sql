-- ProjectPhoenix Complete Database Setup
...
-- Create project_spaces table WITH level column
...
-- Create project_measurements table WITH level column
...
-- Insert default space library data
